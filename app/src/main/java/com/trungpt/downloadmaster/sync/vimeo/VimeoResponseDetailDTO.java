...
public class VimeoResponseDetailDTO
{
    ...
    @SerializedName("user")
    private VimeoResponseUserDTO vimeoResponseUserDTO;
    ...
    public VimeoResponseUserDTO getVimeoResponseUserDTO()
    {
        return vimeoResponseUserDTO;
    }

    public void setVimeoResponseUserDTO(VimeoResponseUserDTO vimeoResponseUserDTO)
    {
        this.vimeoResponseUserDTO = vimeoResponseUserDTO;
    }
}
